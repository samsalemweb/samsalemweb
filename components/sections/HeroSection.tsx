                            ...
                            <div className="flex flex-row gap-2 w-full">
                                ...
                                >
                                    <Link
                                        ...
                                        className="border border-[#C9A84C] text-black bg-transparent hover:bg-[#C9A84C] hover:text-black transition-all duration-300 font-cinzel tracking-widest text-[10px] h-12 px-4 whitespace-nowrap inline-flex items-center justify-center rounded-full w-full"
                                        style={{ boxShadow: '0 0 12px rgba(201,168,76,0.3)' }}
                                    >
                                        {ctaButtons[1].label}
                                    </Link>
